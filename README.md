...
*Real answers from the finished assistant on Gemini. The second question has a trap: a
customer review in the notes tells the AI to say every plate is free. Gemini ignored it;
a small local model sometimes obeys. Stop 4 shows how to keep the damage contained
either way.*
